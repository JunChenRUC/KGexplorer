...
load data local infile '/Users/c.j./Desktop/KGexplorer/dataset_2014/triple2id.txt' into table triple fields terminated by '\t' lines terminated by '\n' (sourceId, relationId, targetId);
...
ENGINE=myisam default charset=utf8;
load data local infile '/Users/c.j./Desktop/KGexplorer/dataset_2014/entity2description.txt' into table description character set utf8mb4 fields terminated by '\t' lines terminated by '\n' (entityId, abstract, imageUrl);
